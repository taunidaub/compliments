...
$DB_Username = "webaccess"; 			//your MySQL User Name 
$DB_Password = "LibeRal@91";    			//your MySQL Password 

$DB_DBName = "compliments";    			//your MySQL Database Name 
...
$where=" where ";
		...
		else if($_REQUEST['date_from']!=''){
			$where.= " date >='".$_REQUEST['date_from']."' and "; 
			if($_REQUEST['date_to']!=''){
				$where.= " date <= '".$_REQUEST['date_to']."' and "; 
			}
		}
		else{
...
$sql =	"select * from new_compliments ".$where ." order by sup_eid desc, rep_eid asc";
//echo $sql."<br>";
...
$title = "Search results from $now_date";
/*
...
header("Content-Disposition: attachment; filename=search_results.$file_ending");
